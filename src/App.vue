...
<template>
    ...
    <router-view/> -->
		<!-- <Cakeindex></Cakeindex> -->
		<router-view />
		<mt-tabbar v-if="isShow" v-model="selected" fixed>
			<mt-tab-item id="index">首页
				<img src="./assets/image/index_enabled.png" v-if="selected == 'index'" slot="icon" />
				<img src="./assets/image/index_disabled.png" v-else slot="icon" />
			</mt-tab-item>
			<mt-tab-item id="sort">分类
				<img src="./assets/image/sort_enabled.png" v-if="selected == 'sort'" slot="icon" />
				<img src="./assets/image/sort_disabled.png" v-else slot="icon" />
			</mt-tab-item>
			<mt-tab-item id="cart">购物车
				<img src="./assets/image/cart_enabled.png" v-if="selected == 'cart'" slot="icon" />
				<img src="./assets/image/cart_disabled.png" v-else slot="icon" />
			</mt-tab-item>
			<mt-tab-item id="me">我的
				<img src="./assets/image/me_enabled.png" v-if="selected == 'me'" slot="icon" />
