<template>
  <div class="details">
    <mt-header title="美丽家蛋糕" fixed>
      ...
      <router-link to="/cakesearch" slot="right"
    ...
    <div class="details_cake">
      <mt-swipe :show-indicators="false">
        ...
        /></mt-swipe-item>
        <mt-swipe-item
          ><img src="../assets/img/010.jpg" alt=""
        /></mt-swipe-item>
        <mt-swipe-item
    ...
    <div id="topleft">
      <!-- 标题开始 -->
      <div class="details_name">{{ category.bname }}/{{ category.dname }}</div>
      <div class="details_price">￥{{ category.price }}</div>
      <div class="details_nid">已售{{ category.sales_count }}件</div>
    </div>
    ...
    <van-cell is-link @click="showPopup" class="details_address"
      >配送至 ---{{ province }} {{ city }} {{ country }}</van-cell
    >
      ...
      <section class="panel">
        <div class="panel-head">
          ...
          <div class="panel-head-link">
            <a href="../../src/assets/picture/welcome_avatar.png"
              >最近已有295条评价<i class="iconfont iconfont-arrow-right"></i
            ></a>
          </div>
        </div>
          ...
          <div class="comments-item">
            <div class="comments-item-head">
              <div class="comments-item-head-left">
                <img
                  ...
                  src="../../src/assets/picture/PTF01照片.jpg"
                  alt="宁*"
                />
            ...
            <div class="comments-item-imglist">
              <div
                ...
                style="
                  background-image: url('../../src/assets/picture/1be705129e1443f180e334d297c32027.jpeg');
                "
              ></div>
            </div>
            <div class="comments-item-address">
              <i class="iconfont iconfont-address"> </i>北京朝阳区
            </div>
          </div>
        </div>
        <div class="panel-body comments">
          <div class="comments-item">
            <div class="comments-item-head">
              <div class="comments-item-head-left">
                <img
                  class="comments-item-head-pic"
                  src="../../src/assets/picture/avatar_default_06.jpg"
                  alt="潇*生"
                />
            ...
            <div class="comments-item-content">
              已经第二次下你们的订单、非常喜欢的一环是当天订当天就送到了、据收方了解、蛋糕非常好吃！搞得我也想订一盒来新加坡！哈哈哈！谢谢和加油各位工作人员！
            </div>
            <div class="comments-item-imglist">
              <div
                class="comments-item-imglist-item"
          ...
          <div class="comments-item">
            <div class="comments-item-head">
              <div class="comments-item-head-left">
                <img
                  class="comments-item-head-pic"
                  src="../../src/assets/picture/041.jpg"
                  alt="谯*"
                />
